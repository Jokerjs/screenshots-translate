...
import { Bounds, Emiter, History, TranslatedImage } from './types'
...
export default function Screenshots ({ url, width, height, lang, className, globalData, setGlobalData, ...props }: ScreenshotsProps): ReactElement {
  ...
  const [translatedImage, setTranslatedImage] = useState<TranslatedImage | null>(null)
