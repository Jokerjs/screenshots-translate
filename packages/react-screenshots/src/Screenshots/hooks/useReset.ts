...
import useTranslatedImage from './useTranslatedImage'
...
export default function useReset (): ResetDispatcher {
  ...
  const [, translatedImageDispatcher] = useTranslatedImage()
  ...
  const reset = useCallback(() => {
    ...
    translatedImageDispatcher.reset()
  }, [emiter, historyDispatcher, boundsDispatcher, cursorDispatcher, operatioDispatcher, translatedImageDispatcher])
